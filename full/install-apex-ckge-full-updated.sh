...
echo -e "${CYAN}"
echo "           claudemods Vanilla Arch/Cachyos Kde Grub to Apex CKGE full v1.02 16-11-2025"
echo -e "${NC}"
echo "================================================================================"
echo ""
...
cp -r /home/$USER/vanillaarch-or-cachyos-to-claudemods-apex-ckge/minimal/claudemods-cyan.colorscheme /home/$USER/.local/share/konsole
cp -r /home/$USER/vanillaarch-or-cachyos-to-claudemods-apex-ckge/minimal/claudemods-cyan.profile /home/$USER/.local/share/konsole
...
cd /home/$USER && wget --show-progress --no-check-certificate --continue --tries=10 --timeout=30 --waitretry=5 https://claudemodsreloaded.co.uk/claudemods-desktop/apex-full.zip
...
unzip -o /home/$USER/apex-full.zip -d /home/$USER
...
sudo rm -rf /home/$USER/apex-full.zip
